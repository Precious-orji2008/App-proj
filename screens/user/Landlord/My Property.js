...
const styles = StyleSheet.create({
  ...
  addButton: { backgroundColor: "#ff7b00", flexDirection: "row", alignItems: "center", paddingVertical: 6, paddingHorizontal: 10, borderRadius: 6 },
  addButtonText: { color: "#fff", fontWeight: "600", marginLeft: 4, fontSize: 13 },
  cardStacked: { backgroundColor: "#fff", borderRadius: 10, marginBottom: 18, overflow: "hidden", elevation: 2 },
  ...
  viewButton: { flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#ff7b00", borderRadius: 6, alignSelf: "flex-start", paddingVertical: 5, paddingHorizontal: 10 },
  viewButtonText: { color: "#ff7b00", marginLeft: 6, fontWeight: "500", fontSize: 13 },

  modalBackdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "center", alignItems: "center" },
  modalContent: { backgroundColor: "#fff", borderRadius: 10, width: "90%", maxHeight: "90%", padding: 16 },
  modalHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 10 },
  modalTitle: { fontSize: 18, fontWeight: "700", color: "#064420" },
  formScroll: { marginTop: 10 },
  sectionTitle: { color: "#064420", fontWeight: "700", marginBottom: 8, fontSize: 15 },
  label: { color: "#064420", fontWeight: "600", marginBottom: 4 },
  input: { backgroundColor: "#f8f8f8", borderRadius: 8, paddingVertical: 8, paddingHorizontal: 12, marginBottom: 12 },
  textArea: { height: 100, textAlignVertical: "top" },
  imageUploadBox: { borderWidth: 1, borderColor: "#8eb69b", borderStyle: "dashed", borderRadius: 8, alignItems: "center", justifyContent: "center", height: 100, marginBottom: 10 },
  previewImage: { width: 80, height: 80, borderRadius: 6, marginRight: 8 },
  saveButton: { backgroundColor: "#ff7b00", flexDirection: "row", justifyContent: "center", alignItems: "center", paddingVertical: 10, borderRadius: 8, marginTop: 10, marginBottom: 20 },
